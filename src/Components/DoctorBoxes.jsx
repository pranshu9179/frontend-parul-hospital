...
import pankaj from "../assets/doctors/passpankaj.webp";
import meeta from "../assets/doctors/passmeeta.webp";
  ...
  const featuredDoctors = [
    {
      ...
      specialization:
        "DM (AIIMS) - Pulmonary Critical Care & Sleep Medicine MD, DNB, MNAMS, DAA (CMC Vellore)",
      image: image,
      timing: (
    ...
    },
    {
      ...
      specialization:
        "DM (AIIMS) - Pulmonary Critical Care & Sleep Medicine, MD",
      image: news,
      timing:
        "Interventional Pulmonologist, Interstitial Lung Disease, Pulmonary Rehabilitation & Sleep Specialist",
    },
    {
      id: 4,
      ...
      image: pankaj,
      timing:
        "Consulting Physician (Diabetes, Hypertension, Cardiac & Gastric Illness Specialist)",
            ...
            <div className="p-5">
              ...
              {doctor.fee && (
                <div className=" md:ml-11 ml-28 mt-1 text-sm text-black font-semibold">
                  Exp:{" "}
                  <span className="whitespace-nowrap text-gray-600  text-[12px]">
                    {doctor.fee}
                  </span>
                </div>
              )}
